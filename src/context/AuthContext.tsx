...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const updateProfile = useCallback(async (updates: Partial<Profile>) => {
    ...
    // Route all student self-updates through the update_student_profile() SECURITY DEFINER RPC.
    // That function enforces a strict column allowlist at the database boundary —
    // no privileged field (role, status, banned, committee_id, etc.) can be written
